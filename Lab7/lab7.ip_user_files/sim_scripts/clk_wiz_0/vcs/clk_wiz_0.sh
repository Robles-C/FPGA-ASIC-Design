...
#
# Generated by Vivado on Wed Oct 11 18:01:52 PDT 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" \
    "$ref_dir/../../../../Lab_5.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Lab_5.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/ptracton/CSUN/CSUN-ECE524L-Fall2023/Examples/Lab_5/Lab_5.cache/compile_simlib/vcs"
  fi
